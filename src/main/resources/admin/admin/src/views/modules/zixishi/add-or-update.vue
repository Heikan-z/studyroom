    ...
    >
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="位置" prop="weizhi">
          <el-select v-model="ruleForm.weizhi" placeholder="请选择位置">
            <el-option label="理科图书馆" value="理科图书馆"></el-option>
            <el-option label="文科图书馆" value="文科图书馆"></el-option>
            <el-option label="A教" value="A教"></el-option>
            <el-option label="智华楼" value="智华楼"></el-option>
          </el-select>
        </el-form-item>
        <div v-else>
